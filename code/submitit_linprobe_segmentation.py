...
import main_linprobe_segmentation as segmentation
import submitit


def parse_args():
    classification_parser = segmentation.get_args_parser()
...
class Trainer(object):
    ...
    def __call__(self):
        import main_linprobe_segmentation as classification
